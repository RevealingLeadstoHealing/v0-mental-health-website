...
export const payerCatalog: Record<BillingJurisdiction, PayerGroup[]> = {
  // Alphabetized by displayed name per owner's Sept 12, 2026 instruction (billing sources
  // categorized and in alphabetical order). Do not resort silently in future edits — if a
  // carrier is added or renamed, re-alphabetize by `name`, not by when it was added.
  NY: [
